...
import com.wmy.scms.dto.*;
import com.wmy.scms.entity.*;
import com.wmy.scms.service.*;
import com.wmy.scms.util.DateFormatterUtil;
import com.wmy.scms.util.ModelExcelListener;
...
public class ExcelController {
    ...
    public void exportAllPersonScore(Score score) throws Exception {
        //设置主体风格
        XSSFWorkbook workbook = new XSSFWorkbook();
        String[] columnNames = {"运动会", "团体名称",  "姓名", "性别", "参赛项目", "项目分数",
                "是否破纪录", "记分员", "分数最后修改时间"};
        Sheet sheet = workbook.createSheet();
        Font titleFont = workbook.createFont();
        titleFont.setFontName("simsun");
