...
public class LogAopController {
    ...
    @Before("!execution(* com.wmy.scms.service.SyslogService.*(..)) && execution(* com.wmy.scms.service.*.add*(..))|| execution(* com.wmy.scms.service.*.modify*(..)) || execution(* com.wmy.scms.service.*.remove*(..)) ")
